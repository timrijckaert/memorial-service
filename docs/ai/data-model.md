...
<!-- Last rebuilt: 2026-04-19T15:31:21Z -->
...
|-------|------|-------------|
| `person.locality` | `string` (non-nullable) | One of: Haaltert, Kerksken, Denderhoutem, Terjoden. Derived from `death_place` (preferred) or `birth_place` via case-insensitive substring matching, defaulting to "Haaltert". Editable in the Review UI. |
