...
<!-- Last rebuilt: 2026-04-19T15:44:32Z -->
...
Fields computed post-extraction and persisted in the card JSON, but not part of the LLM output schema:

| Field | Type | Description |
|-------|------|-------------|
| `person.locality` | `string` (non-nullable) | One of: Haaltert, Kerksken, Denderhoutem, Terjoden, Heldergem. Derived from `death_place` (preferred) or `birth_place` via case-insensitive substring matching, defaulting to "Haaltert". Editable in the Review UI. |
