...
<!-- Last rebuilt: 2026-04-19T17:41:46Z -->
...
### `extract_one(front_path: Path, back_path: Path | None, json_dir: Path, backend: LLMBackend | None, system_prompt: str | None, vision_prompt: str | None, on_step: Callable[[str], None] | None = None) -> ExtractionResult`
